...
- Title: Sci-Fi Sounds (spaceEngineLow_002.ogg)
...
- Title: Sci-Fi Sounds (thrusterFire_000.ogg)
- Author: Kenney (kenney.nl)
- Source: https://kenney.nl/assets/sci-fi-sounds
- License: CC0 1.0 Universal (Public Domain)
- https://creativecommons.org/publicdomain/zero/1.0/
...
- Title: Level up, power up, Coin get (Rise05.aif, converted to WAV)
- Author: wobbleboxx
...
- space_backdrop.png
  ...
  - Author: beren77
  - Source: https://opengameart.org/content/space-backdrop
  - License: CC0 1.0 Universal (Public Domain)
  - https://creativecommons.org/publicdomain/zero/1.0/

- spr_stars01.png, spr_stars02.png
  - Title: Stars - Parallax Backgrounds
  - Author: Bonsaiheldin
